...
enum en_PACKET_SS_MONITOR_DATA_UPDATE
{
	...
	dfMONITOR_DATA_TYPE_GAME_AUTH_PLAYER = 14,		// 게임서버 Match Contents 플레이어 수
	dfMONITOR_DATA_TYPE_GAME_GAME_PLAYER = 15,		// 게임서버 Fight Contents 플레이어 수
	...
	dfMONITOR_DATA_TYPE_GAME_FIGHT_ALLOC = 21,		// FightAlloc 초당 처리 횟수
	dfMONITOR_DATA_TYPE_GAME_FIGHT_FREE = 22,		// FightFree 초당 처리 횟수
	dfMONITOR_DATA_TYPE_GAME_CTRL_Q = 23,			// CtrlQueue 큐 개수 (남은 수)
	dfMONITOR_DATA_TYPE_GAME_PACKET_POOL = 24,		// 게임서버 패킷풀 사용량
	dfMONITOR_DATA_TYPE_GAME_FIGHT_CONTENTS_USING = 25,		// 게임서버 사용중인 전투 컨텐츠 수
	...
	dfMONITOR_DATA_TYPE_GAME_DB_WAIT_AVG=37,				//게임서버 DB 큐 대기시간 평균
	dfMONITOR_DATA_TYPE_GAME_DB_WAIT_MAX=38,				//게임서버 DB 큐 대기시간 MAX

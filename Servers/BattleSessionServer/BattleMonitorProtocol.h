...
enum en_PACKET_SS_MONITOR_DATA_UPDATE_DataType
{
	...
	dfMONITOR_DATA_TYPE_GAME_FIGHT_CONTENTS_USING = 24,		// 게임서버 사용중인 전투 컨텐츠 수
	dfMONITOR_DATA_TYPE_GAME_FIGHT_FPS_AVG = 25,			//게임서버 FightContents 평균 FPS
	dfMONITOR_DATA_TYPE_GAME_FIGHT_FPS_MIN = 26,			//게임서버 FightContents 최소 FPS
	dfMONITOR_DATA_TYPE_GAME_FIGHT_FPS_MAX = 27,			//게임서버 FightContents 최대 FPS
